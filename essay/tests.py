...
class QuestionIndexViewTests(TestCase):
    def test_no_questions(self):
        ...
        """
        response = self.client.get(reverse('essay:index'))
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, "No essays are available.")
    ...
    def test_two_past_questions(self):
        """
        The questions index page may display mulitple questions.
        """
...
class QuestionDetailViewTest(TestCase):
    def test_future_question(self):
        ...
        response = self.client.get(reverse('essay:detail', args=(future_question.id,)))
        self.assertEqual(response.status_code, 404)


    def test_past_question(self):
        """
        The detail view of a question with a pub_date in the past displays the questionäs text.
        """
        past_question = create_question(question_text="Past Question", days=-30)
        response = self.client.get(reverse('essay:detail', args=(past_question.id,)))
